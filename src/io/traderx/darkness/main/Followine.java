...
public class Followine {
	...
	public Followine(String dealer, String gameTable, String server, String mode, String entryOption, String inputRes, String bofp, String boap, String sefp, String seap, int offset, int triggerLevel, int baseBet, int sl, int tp) {
		super();
		this.init();
		this.dealer = dealer;
...
//		System.out.println("bsPattern=" + this.bsPattern);
//		System.out.println("eoPattern=" + this.eoPattern);
	}
...
//		this.isResultTriple = false;
	...
	public String toString() {
		return "Followine [bsPattern="+ bsPattern + ", eoPattern=" + eoPattern + ", baseBet=" + baseBet + ", offset=" + offset + ", sl=" + sl + ", tp=" + tp + ", triggerLevel="
				+ triggerLevel + ", bofp=" + bofp + ", boap=" + boap + ", sefp=" + sefp + ", seap=" + seap + ", mode="
				+ mode + ", dealer=" + dealer + ", gameTable=" + gameTable + ", server=" + server + "]";
	}
